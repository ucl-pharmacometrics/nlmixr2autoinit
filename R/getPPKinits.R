...
#' @param control A list generated by `initsControl()` that specifies the configuration for the parameter estimation pipeline. The list contains the following sub-components:
#'   - `pooled.control`: Settings for handling pooled pharmacokinetic data (see `pooled_control()`).
#'   - `nca.control`: Configuration options for non-compartmental analysis (NCA) procedures (see `nca_control()`).
