...
#'   }
#'
#' @param pooled_ctrl A list of control settings generated by
#'   pooled_control() to define pooling rules for half-life estimation.
#'
...
#'
#' @return An object of class list containing processed data, steady-state data, and mean clearance.
#'
#'
#' @examples
...
#'
#' @param dat A data frame containing pharmacokinetic data. Must include at least
